  ...
  return (
    <div className="min-h-screen bg-victory-bg pb-nav" data-testid="competition-detail-page">
      <header className="p-4 flex items-center gap-3 border-b border-victory-border">
        <button onClick={() => navigate("/compete")} className="w-10 h-10 rounded-full bg-victory-card border border-victory-border flex items-center justify-center touch-target">
