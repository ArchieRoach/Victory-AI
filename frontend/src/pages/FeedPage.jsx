        ...
        <div className="border-t border-victory-border px-4 py-3 space-y-3">
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              ...
              className="w-11 h-11 touch-target rounded-full bg-victory-lime flex items-center justify-center disabled:opacity-40"
            >
      ...
      <header className="sticky top-0 bg-victory-bg/95 backdrop-blur-sm border-b border-victory-border z-10">
        <div className="flex items-center justify-between px-4 pt-4 pb-2">
          ...
          <button
            ...
            className="w-11 h-11 touch-target rounded-full bg-victory-lime flex items-center justify-center"
